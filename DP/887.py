...
We need to use binary search speed up. We can know that function dp(k - 1, i - 1) is increasing when i increases and k is not change 
while function dp(k, n - i) is decreasing when i increases and k, n not change.
So these two functions would have a intercetion which is the answer
